 ...
 */
    const jwt_decode = require('./lib/index')

// use amd or just throught to window object.
    if (typeof global.window.define === 'function' && global.window.define.amd) {
      global.window.define('jwt_decode', () => jwt_decode)
